...
void exec_LR_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [LR.W] rd: %d; rs1: %d",hart->pc,rd(inst),rs1(inst));
}
void exec_SC_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [SC.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
...
void exec_AMOSWAP_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOSWAP.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOADD_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOADD.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOXOR_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOXOR.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOAND_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOAND.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOOR_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOOR.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOMIN_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOMIN.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOMAX_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOMAX.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOMINU_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOMINU.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}
void exec_AMOMAXU_W(struct HART *hart, uint32_t inst) {
    ...
    print_d(hart,"{0x%.8X} [AMOMAXU.W] rd: %d; rs1: %d; rs2: %d",hart->pc,rd(inst),rs1(inst),rs2(inst));
}